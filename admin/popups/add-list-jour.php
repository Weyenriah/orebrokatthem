<div class="add-list-container" id="add-list-jour">
    <article class="add-list">
        <div class="add-header">
            <h2> Lägg till Nytt Listobjekt </h2>
            <button type="button" onclick="hidePopupAddListJour()"> <i class="fas fa-times"></i> </button>
        </div>
