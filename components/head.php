<head>
    ...
    <link rel="stylesheet" type="text/css" href="style/components/second-navigation.css"> <!-- Second navigation (not homepage) -->
    ...
    <link rel="stylesheet" type="text/css" href="style/components/navigation.css">
